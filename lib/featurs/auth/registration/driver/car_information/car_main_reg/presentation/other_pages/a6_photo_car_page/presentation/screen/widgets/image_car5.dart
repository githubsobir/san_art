...
class _PhotoCarPhoto5State extends ConsumerState<PhotoCarPhoto5> {
      ...
      appBar: AppBar(
        ...
        actions: [
          GestureDetector(
            onTap: () {
              try {
                if (carPhotoNotifier.file5?.path.isNotEmpty == true) {
                  Navigator.of(context).pop();
          ...
          child: Center(
            child: Column(
              ...
              children: [
                ...
                PrimaryButton(
                  onPressed: () {
                    carPhotoNotifier.getImageCamera(4);
                  },
                  text: "Сделать фото",
                ),
                const SizedBox(height: 25),
  ...
  bool hasFile5() {
    try {
      final file = ref.read(controllerCarPhoto6.notifier).file5;
