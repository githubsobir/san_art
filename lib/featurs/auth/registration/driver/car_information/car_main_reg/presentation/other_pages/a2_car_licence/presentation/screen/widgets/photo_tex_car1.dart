...
@RoutePage()
class PhotoTexCar1Page extends ConsumerStatefulWidget {
  final int indexImage;

  const PhotoTexCar1Page({super.key, required this.indexImage});

  @override
  ConsumerState<PhotoTexCar1Page> createState() => _PhotoTexCar1State();
}

class _PhotoTexCar1State extends ConsumerState<PhotoTexCar1Page> {
  @override
                            ...
                            GestureDetector(
                              ...
                              child: Container(
                                ...
                                child: getDataFile(widget.indexImage) == "1"
                                    ? Image.file(widget.indexImage == 0
                                        ? ref
