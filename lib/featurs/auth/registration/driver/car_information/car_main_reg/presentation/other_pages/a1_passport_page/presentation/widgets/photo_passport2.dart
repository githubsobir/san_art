...
@RoutePage()
class PhotoPassport2Page extends ConsumerStatefulWidget {
  const PhotoPassport2Page({super.key});

  @override
  ConsumerState<PhotoPassport2Page> createState() => _PhotoPassport2State();
}

class _PhotoPassport2State extends ConsumerState<PhotoPassport2Page> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
              ...
              try {
                ref.read(controllerPassport.notifier).file2.path.length > 10
                    ? {
                        ...
                        ref.read(controllerPassport.notifier).setDefault()
                      }
                    : {};
              } catch (e) {
                log(e.toString());
      ...
      body: ref.watch(controllerPassport).boolGetData
          ? backImage1(
              ref: ref,
              child: SafeArea(
                child: Container(
  ...
  String getDataFile() {
    try {
      return ref.watch(controllerPassport.notifier).file2.path.length >= 10
          ? "1"
          : "0";
    } catch (e) {
      return "0";
