...
class MapDataSourceImpl implements MapDataSource {
  ...
  Future<Result<List<ModelMap>, Failure>> data(LangLatModel langLat) async {
    try {
      return Success([
        ModelMap(id: "1", name: "name", description: "description", langLat: [
          LangLatModel(lang: "41.3089943", lat: "69.2742636")
        ], images: [
          ImagesModel(
              id: "id",
              url:
        ...
        ModelMap(id: "1", name: "name", description: "description", langLat: [
          LangLatModel(lang: "41.3019943", lat: "69.2792636")
        ], images: [
          ImagesModel(
              id: "id",
              url:
        ...
        ModelMap(id: "1", name: "name", description: "description", langLat: [
          LangLatModel(lang: "41.3189943", lat: "69.2762636")
        ], images: [
          ImagesModel(
              id: "id",
              url:
        ...
        ModelMap(id: "1", name: "name", description: "description", langLat: [
          LangLatModel(lang: "41.3289943", lat: "69.2342636")
        ], images: [
          ImagesModel(
              id: "id",
              url:
